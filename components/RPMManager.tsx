      ...
      {!user.apiKey && (
        <div className="bg-rose-50 border-2 border-rose-200 p-6 rounded-[2rem] flex items-start gap-4 animate-pulse">
          ...
          <div>
            ...
            <p className="text-xs text-rose-700 font-medium mt-1">Anda belum memasukkan Gemini API Key di profil. Fitur "Uraikan dengan AI" tidak akan berfungsi. Silakan lengkapi di halaman <button onClick={() => onNavigate('PROFILE')} className="underline font-black">Profil Saya</button>.</p>
          </div>
        </div>
      )}
